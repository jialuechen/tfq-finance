...
def price_carbon_credit(spot_price, strike_price, volatility, risk_free_rate, maturity, num_qubits=3, steps=100, learning_rate=0.1):
...
if __name__ == "__main__":
    ...
    option_price = price_carbon_credit(spot_price, strike_price, volatility, risk_free_rate, maturity)
    print(f"Carbon Credit Option Price: {option_price}")
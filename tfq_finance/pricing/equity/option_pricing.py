...
def price_equity_option(spot_price, strike_price, volatility, risk_free_rate, maturity, num_qubits=3, steps=100, learning_rate=0.1):
    ...
    def expected_payoff(params):
        ...
        payoff = max(0, spot_price - strike_price)
...
if __name__ == "__main__":
    ...
    option_price = price_equity_option(spot_price, strike_price, volatility, risk_free_rate, maturity)
    print(f"Equity Option Price: {option_price}")
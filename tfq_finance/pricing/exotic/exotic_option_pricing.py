...
def price_exotic_option(spot_price, strike_price, volatility, risk_free_rate, maturity, barrier_level, num_qubits=3, steps=100, learning_rate=0.1):
    ...
    def expected_payoff(params):
        ...
        payoff = max(0, forward_price - strike_price) if forward_price >= barrier_level else 0
...
if __name__ == "__main__":
    ...
    option_price = price_exotic_option(spot_price, strike_price, volatility, risk_free_rate, maturity, barrier_level)
    print(f"Exotic Option Price: {option_price}")
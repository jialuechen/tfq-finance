...
def price_abs(notional, attachment_point, detachment_point, default_prob, recovery_rate, maturity, num_qubits=3, steps=100, learning_rate=0.1):
    ...
    for step in range(steps):
        loss = model.train_on_batch(quantum_data, expected_abs_value(param_values))
        param_values -= learning_rate * loss

    return expected_abs_value(param_values)
...
if __name__ == "__main__":
    ...
    abs_value = price_abs(notional, attachment_point, detachment_point, default_prob, recovery_rate, maturity)

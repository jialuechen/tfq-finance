...
def simulate_brownian_motion(initial_value, volatility, time_horizon, num_steps, num_qubits=3, steps=100, learning_rate=0.1):
    ...
    def expected_value(params):
        ...
        for _ in range(num_steps):
            ...
            values.append(values[-1] + volatility * dW)
...
if __name__ == "__main__":
    ...
    bm_value = simulate_brownian_motion(initial_value, volatility, time_horizon, num_steps)
    print(f"Brownian Motion Simulated Value: {bm_value}")
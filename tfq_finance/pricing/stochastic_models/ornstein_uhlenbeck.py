...
def simulate_ornstein_uhlenbeck(initial_value, mean_reversion_speed, long_term_mean, volatility, time_horizon, num_steps, num_qubits=3, steps=100, learning_rate=0.1):
...
if __name__ == "__main__":
    ...
    ou_value = simulate_ornstein_uhlenbeck(initial_value, mean_reversion_speed, long_term_mean, volatility, time_horizon, num_steps)
    print(f"Ornstein-Uhlenbeck Simulated Value: {ou_value}")
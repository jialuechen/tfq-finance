...
def simulate_jump_diffusion(initial_value, drift, volatility, jump_intensity, jump_mean, jump_std, time_horizon, num_steps, num_qubits=3, steps=100, learning_rate=0.1):
...
if __name__ == "__main__":
    ...
    jd_value = simulate_jump_diffusion(initial_value, drift, volatility, jump_intensity, jump_mean, jump_std, time_horizon, num_steps)
    print(f"Jump Diffusion Simulated Value: {jd_value}")
...
def create_quantum_regression_model(qubits, layers):
...
def train_quantum_regression_model(train_data, train_labels, qubits=4, layers=2, epochs=100, learning_rate=0.1):
    circuit, params = create_quantum_regression_model(qubits, layers)

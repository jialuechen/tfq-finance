...
def tax_loss_harvesting_optimization(num_qubits, steps=100, learning_rate=0.1):
...
if __name__ == "__main__":
    num_qubits = 3
    result = tax_loss_harvesting_optimization(num_qubits)
    print(f"Optimized Tax Loss Harvesting Value: {result}")